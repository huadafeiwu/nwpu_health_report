...
browser.find_element(By.XPATH, "//i[@class='weui-btn weui-btn_primary']").click() # 提交填报信息 
browser.find_element(By.XPATH, "//i[@class='weui-icon-checked']").click() # 已核实 
browser.find_element(By.XPATH, "//i[@class='weui-btn weui-btn_primary t10']").click() # 确认提交 
time.sleep(1)
